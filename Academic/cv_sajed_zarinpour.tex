...
\begin{document}
	...
	\languageEnry{ English}{C1 (Proficient user)} % Listening C1, Reading B2, Spoken Interaction C1, Spoken Production C1, Writing C1
...
%	\selfAssessedEng{C1}{B2}{C1}{C1}{C1} % Listening, Reading, Spoken Interaction, Spoken Production, Writing
	...
	\languageEnry{German}{A2 (Basic user)} % Listening A1, Reading A1, Spoken Interaction A1, Spoken Production A1, Writing A1 \\\\
